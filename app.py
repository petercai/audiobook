...
def main():
    options = [
        ...
        "--length_penalty",  # 14
        "--num_beams",  # 15
        "--repetition_penalty",  # 16
        "--top_k",  # 17
        "--top_p",  # 18
        "--speed",  # 19
        "--enable_text_splitting",  # 20
        "--text_temp",  # 21
        "--waveform_temp",  # 22
        "--output_dir",  # 23
        "--version",  # 24
...
Tip: to add of silence (1.4 seconds) into your text just use "###" or "[pause]".
    ...
    headless_group.add_argument(
        options[3], action="store_true", help="""Run the script in headless mode"""
    )
    headless_group.add_argument(
        options[4],
        type=str,
    ...
    headless_optional_group.add_argument(
        ...
        choices=device_list,
        help=f"""(Optional) Pprocessor unit type for the conversion. 
    ...
    headless_optional_group.add_argument(
        ...
        help=f"""(Optional) Output audio format. Default is set in ./lib/conf.py""",
    )
    headless_optional_group.add_argument(
        options[13],
        type=float,
