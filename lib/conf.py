...
default_output_split_minutes = '30' # if the final output exceed output_split_minutes * 2 minutes the final file will be splitted by output_split_minutes + the end if any.