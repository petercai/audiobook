...
class TextNormalizer:
    def __init__(self, lang_iso1=None, offline_model=False):
    ...
    def normalize_text_4_tts(self, text_block, tts_engine):
        if self.lang_iso1 == "zh" and tts_engine in TOKENIZER_FREE_TTS:
